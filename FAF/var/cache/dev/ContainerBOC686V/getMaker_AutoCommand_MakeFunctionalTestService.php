...
class getMaker_AutoCommand_MakeFunctionalTestService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['maker.auto_command.make_functional_test'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(($container->privates['maker.maker.make_functional_test'] ?? ($container->privates['maker.maker.make_functional_test'] = new \Symfony\Bundle\MakerBundle\Maker\MakeFunctionalTest())), ($container->privates['maker.file_manager'] ?? $container->load('getMaker_FileManagerService')), ($container->privates['maker.generator'] ?? $container->load('getMaker_GeneratorService')));
