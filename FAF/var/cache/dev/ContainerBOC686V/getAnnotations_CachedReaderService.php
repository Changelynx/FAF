...
class getAnnotations_CachedReaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotations.cached_reader'] = new \Doctrine\Common\Annotations\CachedReader(($container->privates['annotations.reader'] ?? $container->load('getAnnotations_ReaderService')), ($container->privates['annotations.cache'] ?? $container->load('getAnnotations_CacheService')), true);
    }
}
