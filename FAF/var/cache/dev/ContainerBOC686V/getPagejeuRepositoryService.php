 ...
 */
class getPagejeuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PagejeuRepository' shared autowired service.
     *
     * @return \App\Repository\PagejeuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PagejeuRepository.php';

        return $container->privates['App\\Repository\\PagejeuRepository'] = new \App\Repository\PagejeuRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
