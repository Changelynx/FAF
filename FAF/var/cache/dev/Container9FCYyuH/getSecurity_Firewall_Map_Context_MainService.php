...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 5), ($container->privates['security.exception_listener.main'] ?? $container->load('getSecurity_ExceptionListener_MainService')), ($container->privates['security.logout_listener.main'] ?? $container->load('getSecurity_LogoutListener_MainService')), ($container->privates['security.firewall.map.config.main'] ?? $container->load('getSecurity_Firewall_Map_Config_MainService')), ($container->privates['security.untracked_token_storage'] ?? ($container->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    }
}
